...
uint8_t MCP9808::read()
{
    ...
    *rp = Wire.read();
    ...
    tUpper    = (((int16_t)(regs[2] & 0x1F) << 11) + ((int16_t)regs[3] << 3)) >> 3;
    tLower    = (((int16_t)(regs[4] & 0x1F) << 11) + ((int16_t)regs[5] << 3)) >> 3;
    tCritical = (((int16_t)(regs[6] & 0x1F) << 11) + ((int16_t)regs[7] << 3)) >> 3;
    tAmbient  = (((int16_t)(regs[8] & 0x1F) << 11) + ((int16_t)regs[9] << 3)) >> 3;
